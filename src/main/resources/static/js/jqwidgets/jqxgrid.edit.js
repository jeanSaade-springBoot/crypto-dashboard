...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        _handledblclick: function(t, n) {
            ...
            var z = this.showfilterbar ? this.toolbarheight : 0;
            o += B;
            o += z;
            ...
            for (var u = 0; u < p.cells.length; u++) {
                ...
                var A = g + a(this.columnsrow[0].cells[u]).width();
                if (A >= m && m >= g) {
                    d = u;
                    break
                }
                            ...
                            case "multiplecellsadvanced":
                                ...
                                if (B != null) {
                                    if (u == 13) {
                                        ...
                                        if (j.editmode !== "selectedrow") {
                                            j.begincelledit(B.rowindex, B.datafield, null, false)
                                        }
                                    }
                                }
                                break
            ...
            switch (H.columntype) {
                            ...
                            if (x) {
                                setTimeout(function() {
                                    ...
                                    if (t.editchar) {
                                        ...
                                        if (e) {
                                            var S = d.jqxNumberInput("numberInput").val();
                                            t._setSelection(d.jqxNumberInput("numberInput")[0], S.length, S.length)
                                        } else {
                                            var S = d.jqxNumberInput("numberInput").val();
                                            t._setSelection(d.jqxNumberInput("numberInput")[0], 0, S.length)
                                        }
                ...
                case "rating":
                    if (this.host.jqxRating) {
                        ...
                        var Q = this.editors["rating_" + E];
                        d = Q == undefined ? a("<div style='margin: 5px;white-space: nowrap; overflow: auto; border:none; border-radius: 0px; -moz-border-radius: 0px; -webkit-border-radius: 0px; z-index: 799; top: 0px; left: 0px; position: absolute;' id='ratingEditor'></div>") : Q;
                        d.show();
                        d.css("top", a(o).parent().position().top);
                        if (this.oldhscroll) {
                            d.css("left", -j + parseInt(a(o).position().left))
                        ...
                        if (Q == undefined) {
                            d.prependTo(this.table);
                            d[0].id = "ratingEditor" + this.element.id + E;
                            d.jqxRating({
                                theme: this.theme,
                                width: h.width(),
                                height: h.height()
                        ...
                        if (L) {
                            ...
                            if (this.editcell.defaultvalue != undefined) {
                                d.jqxRating("val", this.editcell.defaultvalue)
                            }
                        }
                    }
                    break;
                        ...
                        if (H.cellsformat != "") {
                            if (H.cellsformat.indexOf("p") != -1 || H.cellsformat.indexOf("c") != -1 || H.cellsformat.indexOf("n") != -1 || H.cellsformat.indexOf("f") != -1) {
                                if (!this.editors["textboxeditor_" + H.datafield]) {
                                    d.keydown(function(S) {
                                        var Y = S.charCode ? S.charCode : S.keyCode ? S.keyCode : 0;
                                        var V = String.fromCharCode(Y);
                                        var W = parseInt(V);
                                        if (isNaN(W)) {
                                            return true
                                        }
                                        ...
                                        var T = d.val();
                                        if (H.cellsformat.length > 1) {
                                            var X = parseInt(H.cellsformat.substring(1));
                                            if (isNaN(X)) {
                                                X = 0
                                            }
                                        } else {
                                        ...
                                        if (X > 0) {
                                            if (T.indexOf(t.gridlocalization.decimalseparator) != -1) {
                                                if (t._selection(d).start > T.indexOf(t.gridlocalization.decimalseparator)) {
                                                    return true
                                                }
                                            }
                                        }
                                        for (var Z = 0; Z < T.length - X; Z++) {
                                            var e = T.substring(Z, Z + 1);
                                            if (e.match(/^[0-9]+$/) != null) {
                                                U += e
                                            }
                                        }
