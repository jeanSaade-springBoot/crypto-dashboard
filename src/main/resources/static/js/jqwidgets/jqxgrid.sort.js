...
(function(a) {
    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        _rendersortcolumn: function() {
            ...
            if (this.sortmode === "many") {
                ...
                a.each(this.columns.records, function(j, k) {
                    ...
                    if (a(this.sorticon)[0]) {
                        a(this.sorticon)[0].removeAttribute("order")
                    }
                });
                if (d.length > 0) {
                    for (var c = 0; c < d.length; c++) {
                        ...
                        g.element.setAttribute("sort-index", c);
                        if (b.isMaterialized() || b.isModern()) {
                            ...
                            a(g.sorticon)[0].setAttribute("order", c + 1);
                            if (e.ascending) {
        ...
        sortby: function(d, h, g, f, b) {
            ...
            if (d != undefined) {
                var c = this.that;
                if (g == undefined && c.source && c.source.sortcomparer != null) {
                ...
                c.sortcolumns[d] = h;
                if (c.source && (c.source.sort || c.virtualmode)) {
