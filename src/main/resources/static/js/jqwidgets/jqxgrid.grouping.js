...
(function(a) {
    ...
    a.extend(a.jqx._jqxGrid.prototype, {
        ...
        jsonParser: function() {
            var k = "~",
                l = "\\x" + ("0" + k.charCodeAt(0).toString(16)).slice(-2),
                o = "\\" + l,
                d = new RegExp(l, "g"),
                m = new RegExp(o, "g"),
                g = new RegExp("(?:^|([^\\\\]))" + o),
                n = [].indexOf || function(s) {
                    for (var t = this.length; t-- && this[t] !== s;) {}
                    return t
                },
                f = String;
            ...
            function c(y, t, C) {
                var D = false,
                    ...
                    u, v;
                if (B) {
                    v = typeof t === "object" ? function(F, G) {
                        return F !== "" && n.call(t, F) < 0 ? void 0 : G
                    } : t
                }
                return function(F, G) {
                    if (B) {
                    ...
                    if (D) {
                        ...
                        if (typeof G === "object" && G) {
                            ...
                            if (typeof G === "string" && C) {
                                G = G.replace(l, o).replace(k, l)
                            }
                        }
                    } else {
                        D = true
            ...
            function q(v, u) {
                for (var s = 0, t = u.length; s < t; v = v[u[s++].replace(m, k)]) {}
                return v
            }

            function b(s) {
                return function(u, v) {
                    var t = typeof v === "string";
                    if (t && v.charAt(0) === k) {
                        return new f(v.slice(1))
                    }
                    if (u === "") {
                        v = h(v, v, {})
                    }
                    if (t) {
                        v = v.replace(g, "$1" + k).replace(o, l)
                    }
                    return s ? s.call(this, u, v) : v
                }
            }
            ...
            function h(s, u, t) {
                return u instanceof Array ? j(s, u, t) : (u instanceof f ? (u.length ? (t.hasOwnProperty(u) ? t[u] : t[u] = q(s, u.split(k))) : s) : (u instanceof Object ? r(s, u, t) : u))
            }
            var p = {
                stringify: function i(v, t, u, s) {
                    return p.parser.stringify(v, c(v, t, !s), u)
                },
                parse: function e(t, s) {
                    return p.parser.parse(t, b(s))
                },
                parser: JSON
            };
            return p
        ...
        getgroup: function(e) {
            var k = this.dataview.loadedrootgroups[e];
            if (k == null) {
                return null
            }
            var f = this.expandedgroups[k.uniqueid].expanded;
            var g = k.group;
            var b = k.level;
            var c = new Array();
            this._getsubgroups(c, k);
            var j = this;
            var d = {
                group: g,
                level: b,
            ...
            var i = this.jsonParser().stringify(k);
            i = i.replace(/subItems/ig, "subrows");
            i = i.replace(/subGroups/ig, "subgroups");
            d = this.jsonParser().parse(i);
            return d
        },
        ...
        _rendergroup: function(p, x, b, v, k, B, u) {
            ...
            if (this.groupsrenderer != null) {
                ...
                if (q) {
                    n.innerHTML = q;
                    x.classList.add("jqx-grid-groups-custom-row");
                    if (this.theme) {
                        x.classList.add("jqx-grid-groups-custom-row-" + this.theme)
                    }
                } else {
                ...
                if (e != null) {
                   ...
                   //customised based on the client request n.innerHTML = '<div class="' + this.toThemeProperty("jqx-grid-groups-row") + '" style="position: absolute;"><span>' + t + ': </span><span class="' + this.toThemeProperty("jqx-grid-groups-row-details") + '">' + z + " (" + l + ")</span></div>"
                   n.innerHTML = '<div class="' + this.toThemeProperty("jqx-grid-groups-row") + '" style="position: absolute;"><span>	&nbsp; </span><span class="' + this.toThemeProperty("jqx-grid-groups-row-details") + '">' + z + "</span></div>"
                } else {
