    ...
    , {
				...
				value: function (t, e, i) {
					...
					if ("square" === i.shape) {
						...
						null !== e && a || (a = 0, r = 0);
						var n = 1.2 * a + r,
							o = this.drawRectMarker(n, n, n, n, r);
						o.attr({
							x: t - n / 2,
							y: e - n / 2,
							cx: t,
		...
		L = function () {
			...
			return a(t, [{
				...
				value: function (t, e, i) {
					...
					//	var g = s.fill.gradient.gradientToColors[r.seriesNumber]; remove seriesNumber since it was truncating the color 
						var g = s.fill.gradient.gradientToColors;
